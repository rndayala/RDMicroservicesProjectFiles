...
public class AccountsController {
    ...
    // @Autowired - commenting this, since we have added @AllArgsConstructor annotation.
    ...
    @Operation(
            ...
            description = "Contact info details that can be reached out incase of any issues"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
